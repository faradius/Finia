...
@Composable
fun VisaMark(color: Color = Color.Unspecified, modifier: Modifier = Modifier) {
    Text("VISA", style = FiniaText.VisaMark, color = color, modifier = modifier)
}

@Composable
fun MastercardMark(size: androidx.compose.ui.unit.Dp = 18.dp, modifier: Modifier = Modifier) {
